...
rem ..\bmp2tile.exe populous.png  -removedupes -mirror -savetiles "populous (tiles).psgcompr" -savetilemap "populous (tilemap).pscompr" -palsms   -savepalette "populous (palette).bin" -exit
